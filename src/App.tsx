...
import { Navbar, Hero, Features, Contact, Footer, ChatWidget, SalesTeam, Process, ProjectGallery, Testimonials, FAQ, SolarDiagram, ROICalculator } from './components/SolarComponents';
